(defproject psw "0.1.0-SNAPSHOT"
  ...
  :ring {:handler psw.handler/app
         :uberwar-name "psw.war"}

  :min-lein-version "2.5.0"
  :uberjar-name "psw.jar"
  :main psw.server
  ...
  {:builds {:min
            ...
            {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
             :figwheel {:on-jsload "psw.core/mount-root"}
             :compiler
             {:main "psw.dev"
              :asset-path "/js/out"
              :output-to "target/cljsbuild/public/js/app.js"
  ...
  :profiles {:dev {:repl-options {:init-ns psw.repl}
