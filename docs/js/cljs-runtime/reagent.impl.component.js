...
if((i < len)){
var k = (ks[i]);
var G__63544 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__63545 = (i + (1));
m = G__63544;
i = G__63545;
continue;
...
var temp__5737__auto__ = p.argv;
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__63321 = p.children;
return module$node_modules$react$index.Children.toArray(G__63321);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__63328 = c;
var G__63328__$1 = (((G__63328 == null))?null:G__63328.prototype);
if((G__63328__$1 == null)){
return null;
} else {
return G__63328__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__63333 = c;
var G__63333__$1 = (((G__63333 == null))?null:G__63333.prototype);
if((G__63333__$1 == null)){
return null;
} else {
return G__63333__$1.render;
}
})() == null)))));
});
...
var G__63352 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__63352) : reagent.impl.component.as_element.call(null,G__63352));
};
var G__63559 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__63560__i = 0, G__63560__a = new Array(arguments.length -  0);
while (G__63560__i < G__63560__a.length) {G__63560__a[G__63560__i] = arguments[G__63560__i + 0]; ++G__63560__i;}
  args = new cljs.core.IndexedSeq(G__63560__a,0,null);
} 
return G__63559__delegate.call(this,args);};
G__63559.cljs$lang$maxFixedArity = 0;
G__63559.cljs$lang$applyTo = (function (arglist__63561){
var args = cljs.core.seq(arglist__63561);
return G__63559__delegate(args);
});
G__63559.cljs$core$IFn$_invoke$arity$variadic = G__63559__delegate;
return G__63559;
})()
;})(c,f,_,res))
:res);
...
var _STAR_current_component_STAR__orig_val__63354 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__63355 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__63355);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__63354);
}});
...
var G__63392 = key;
var G__63392__$1 = (((G__63392 instanceof cljs.core.Keyword))?G__63392.fqn:null);
switch (G__63392__$1) {
...
var c = this;
var G__63413_63643 = goog.object.get(c,"cljsRatom");
if((G__63413_63643 == null)){
} else {
reagent.ratom.dispose_BANG_(G__63413_63643);
}
...
var renders_63657 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_63658 = cljs.core.first(cljs.core.vals(renders_63657));
...
if((cljs.core.count(renders_63657) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_63657))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_63658)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_63658], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__63419 = o;
var G__63420_63667 = G__63419;
var G__63421_63668 = cljs.core.name(k);
var G__63422_63669 = v;
goog.object.set(G__63420_63667,G__63421_63668,G__63422_63669);
...
var G__63455_63681 = cmp.prototype;
var G__63456_63682 = module$node_modules$react$index.Component.prototype;
var G__63457_63683 = methods$;
goog.object.extend(G__63455_63681,G__63456_63682,G__63457_63683);
...
var name = (function (){var G__63462 = fiber;
var G__63462__$1 = (((G__63462 == null))?null:G__63462.type);
if((G__63462__$1 == null)){
return null;
} else {
return G__63462__$1.displayName;
}
})();
var parent = (function (){var G__63466 = fiber;
if((G__63466 == null)){
return null;
} else {
return G__63466.return;
}
})();
var path = (function (){var G__63467 = parent;
var G__63467__$1 = (((G__63467 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__63467) : reagent.impl.component.fiber_component_path.call(null,G__63467)));
if((G__63467__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__63467__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4185__auto__ = (function (){var G__63469 = c;
if((G__63469 == null)){
return null;
} else {
return goog.object.get(G__63469,"_reactInternalFiber");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__63470._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4185__auto__ = (function (){var G__63476 = c;
if((G__63476 == null)){
return null;
} else {
return goog.object.get(G__63476,"_reactInternalInstance");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var or__4185__auto____$1 = (function (){var G__63484 = c;
if((G__63484 == null)){
return null;
} else {
return G__63484._reactInternalInstance;
}
})();
if(cljs.core.truth_(or__4185__auto____$1)){
return or__4185__auto____$1;
...
var elem = (function (){var or__4185__auto__ = (function (){var G__63492 = instance;
if((G__63492 == null)){
return null;
} else {
return goog.object.get(G__63492,"_currentElement");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var G__63498 = instance;
if((G__63498 == null)){
return null;
} else {
return G__63498._currentElement;
}
}
})();
var name = (function (){var G__63499 = elem;
var G__63499__$1 = (((G__63499 == null))?null:G__63499.type);
if((G__63499__$1 == null)){
return null;
} else {
return G__63499__$1.displayName;
}
})();
var owner = (function (){var or__4185__auto__ = (function (){var G__63502 = elem;
if((G__63502 == null)){
return null;
} else {
return goog.object.get(G__63502,"_owner");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__63504._owner;
}
}
})();
var path = (function (){var G__63505 = owner;
var G__63505__$1 = (((G__63505 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__63505) : reagent.impl.component.component_path.call(null,G__63505)));
if((G__63505__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__63505__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__63508 = c;
var G__63508__$1 = (((G__63508 == null))?null:G__63508.constructor);
if((G__63508__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__63508__$1);
}
}
})();
