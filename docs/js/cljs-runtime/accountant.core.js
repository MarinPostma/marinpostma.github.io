...
var G__67007 = history;
var G__67008 = goog.history.EventType.NAVIGATE;
var G__67009 = (function (e){
var token = e.token;
...
return goog.events.listen(G__67007,G__67008,G__67009);
});
/**
...
var G__67050 = document;
var G__67051 = "click";
var G__67052 = (function (e){
var target = e.target;
var button = e.button;
...
if(cljs.core.truth_(((cljs.core.not(any_key))?(function (){var and__4174__auto__ = (function (){var fexpr__67073 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["",null,"_self",null], null), null);
return (fexpr__67073.cljs$core$IFn$_invoke$arity$1 ? fexpr__67073.cljs$core$IFn$_invoke$arity$1(link_target) : fexpr__67073.call(null,link_target));
})();
if(cljs.core.truth_(and__4174__auto__)){
...
var G__67135 = history;
var G__67136 = (new goog.history.Event(path,true));
return goog.events.dispatchEvent(G__67135,G__67136);
} else {
return null;
}
} else {
...
return goog.events.listen(G__67050,G__67051,G__67052);
});
 ...
 */
accountant.core.configure_navigation_BANG_ = (function accountant$core$configure_navigation_BANG_(p__67159){
var map__67160 = p__67159;
var map__67160__$1 = (((((!((map__67160 == null))))?(((((map__67160.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__67160.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__67160):map__67160);
var nav_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67160__$1,new cljs.core.Keyword(null,"nav-handler","nav-handler",2039495484));
var path_exists_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67160__$1,new cljs.core.Keyword(null,"path-exists?","path-exists?",1473384514));
var reload_same_path_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67160__$1,new cljs.core.Keyword(null,"reload-same-path?","reload-same-path?",1981904231));
...
var seq__67170 = cljs.core.seq(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [accountant.core.document_click_handler_listener_key,accountant.core.navigate_listener_key], null));
var chunk__67171 = null;
var count__67172 = (0);
var i__67173 = (0);
while(true){
if((i__67173 < count__67172)){
var key = chunk__67171.cljs$core$IIndexed$_nth$arity$2(null,i__67173);
...
var G__67261 = seq__67170;
var G__67262 = chunk__67171;
var G__67263 = count__67172;
var G__67264 = (i__67173 + (1));
seq__67170 = G__67261;
chunk__67171 = G__67262;
count__67172 = G__67263;
i__67173 = G__67264;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__67170);
if(temp__5735__auto__){
var seq__67170__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__67170__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__67170__$1);
var G__67265 = cljs.core.chunk_rest(seq__67170__$1);
var G__67266 = c__4609__auto__;
var G__67267 = cljs.core.count(c__4609__auto__);
var G__67268 = (0);
seq__67170 = G__67265;
chunk__67171 = G__67266;
count__67172 = G__67267;
i__67173 = G__67268;
continue;
} else {
var key = cljs.core.first(seq__67170__$1);
if(cljs.core.truth_(key)){
goog.events.unlistenByKey(key);
} else {
}
...
var G__67272 = cljs.core.next(seq__67170__$1);
var G__67273 = null;
var G__67274 = (0);
var G__67275 = (0);
seq__67170 = G__67272;
chunk__67171 = G__67273;
count__67172 = G__67274;
i__67173 = G__67275;
continue;
}
} else {
...
var params = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__67191_SHARP_){
return cljs.core.name(p1__67191_SHARP_);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("&",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__67192_SHARP_){
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("=",p1__67192_SHARP_);
}),pairs));
});
/**
...
if(cljs.core.truth_(accountant.core.nav_handler)){
var G__67221 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(query),cljs.core.str.cljs$core$IFn$_invoke$arity$1(hash)].join('');
return (accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1 ? accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1(G__67221) : accountant.core.nav_handler.call(null,G__67221));
} else {
