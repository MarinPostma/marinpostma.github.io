...
cljs.spec.alpha.def_impl(new cljs.core.Keyword("markdown-to-hiccup.core","options","markdown-to-hiccup.core/options",439665020),cljs.core.list(new cljs.core.Symbol("cljs.spec.alpha","keys","cljs.spec.alpha/keys",1109346032,null),new cljs.core.Keyword(null,"opt-un","opt-un",883442496),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("markdown-to-hiccup.core","encode?","markdown-to-hiccup.core/encode?",-1516433262)], null)),cljs.spec.alpha.map_spec_impl(cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"req-un","req-un",1074571008),new cljs.core.Keyword(null,"opt-un","opt-un",883442496),new cljs.core.Keyword(null,"gfn","gfn",791517474),new cljs.core.Keyword(null,"pred-exprs","pred-exprs",1792271395),new cljs.core.Keyword(null,"keys-pred","keys-pred",858984739),new cljs.core.Keyword(null,"opt-keys","opt-keys",1262688261),new cljs.core.Keyword(null,"req-specs","req-specs",553962313),new cljs.core.Keyword(null,"req","req",-326448303),new cljs.core.Keyword(null,"req-keys","req-keys",514319221),new cljs.core.Keyword(null,"opt-specs","opt-specs",-384905450),new cljs.core.Keyword(null,"pred-forms","pred-forms",172611832),new cljs.core.Keyword(null,"opt","opt",-794706369)],[null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("markdown-to-hiccup.core","encode?","markdown-to-hiccup.core/encode?",-1516433262)], null),null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (G__67522){
return cljs.core.map_QMARK_(G__67522);
})], null),(function (G__67522){
return cljs.core.map_QMARK_(G__67522);
...
var len__4789__auto___67670 = arguments.length;
var i__4790__auto___67671 = (0);
while(true){
if((i__4790__auto___67671 < len__4789__auto___67670)){
args__4795__auto__.push((arguments[i__4790__auto___67671]));

var G__67673 = (i__4790__auto___67671 + (1));
i__4790__auto___67671 = G__67673;
continue;
} else {
}
break;
...
var G__67674 = cljs.core.rest(hiccup);
var G__67675 = kws;
hiccup = G__67674;
kws = G__67675;
continue;
...
var G__67677 = cljs.core.rest(hiccup);
var G__67678 = kws;
hiccup = G__67677;
kws = G__67678;
continue;
...
var G__67679 = hiccup;
var G__67680 = cljs.core.rest(kws);
hiccup = G__67679;
kws = G__67680;
continue;
} else {
var G__67681 = cljs.core.rest(hiccup);
var G__67682 = kws;
hiccup = G__67681;
kws = G__67682;
continue;
...
/** @this {Function} */
(markdown_to_hiccup.core.hicc_in.cljs$lang$applyTo = (function (seq67579){
var G__67580 = cljs.core.first(seq67579);
var seq67579__$1 = cljs.core.next(seq67579);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__67580,seq67579__$1);
}));

markdown_to_hiccup.core.keywords_QMARK_ = (function markdown_to_hiccup$core$keywords_QMARK_(var_args){
var args__4795__auto__ = [];
var len__4789__auto___67684 = arguments.length;
var i__4790__auto___67685 = (0);
while(true){
if((i__4790__auto___67685 < len__4789__auto___67684)){
args__4795__auto__.push((arguments[i__4790__auto___67685]));

var G__67686 = (i__4790__auto___67685 + (1));
i__4790__auto___67685 = G__67686;
continue;
} else {
}
break;
...
/** @this {Function} */
(markdown_to_hiccup.core.keywords_QMARK_.cljs$lang$applyTo = (function (seq67602){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq67602));
}));
...
var vec__67617 = cljs.core.first(kw_pairs);
var kw = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67617,(0),null);
var count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67617,(1),null);
...
var G__67696 = cljs.core.rest(arglist);
var G__67697 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret_vec,(0),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([curr_arg], 0));
arglist = G__67696;
ret_vec = G__67697;
continue;
} else {
var G__67699 = cljs.core.rest(arglist);
var G__67700 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(ret_vec,curr_arg);
arglist = G__67699;
ret_vec = G__67700;
continue;
...
while(true){
var vec__67629 = cljs.core.first(kw_pairs);
var kw = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67629,(0),null);
var nth_kw = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67629,(1),null);
...
var G__67702 = remaining;
var G__67703 = kw_pairs;
hiccup = G__67702;
kw_pairs = G__67703;
continue;
} else {
...
var G__67704 = remaining;
var G__67705 = markdown_to_hiccup.core.dec_front(kw_pairs);
hiccup = G__67704;
kw_pairs = G__67705;
continue;
} else {
var G__67706 = remaining;
var G__67707 = kw_pairs;
hiccup = G__67706;
kw_pairs = G__67707;
continue;
}
...
var G__67709 = remaining;
var G__67710 = new_pairs;
hiccup = G__67709;
kw_pairs = G__67710;
continue;
...
var G__67711 = remaining;
var G__67712 = kw_pairs;
hiccup = G__67711;
kw_pairs = G__67712;
continue;
...
var args__4795__auto__ = [];
var len__4789__auto___67713 = arguments.length;
var i__4790__auto___67714 = (0);
while(true){
if((i__4790__auto___67714 < len__4789__auto___67713)){
args__4795__auto__.push((arguments[i__4790__auto___67714]));

var G__67715 = (i__4790__auto___67714 + (1));
i__4790__auto___67714 = G__67715;
continue;
} else {
}
break;
...
/** @this {Function} */
(markdown_to_hiccup.core.hiccup_in.cljs$lang$applyTo = (function (seq67635){
var G__67636 = cljs.core.first(seq67635);
var seq67635__$1 = cljs.core.next(seq67635);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__67636,seq67635__$1);
}));
