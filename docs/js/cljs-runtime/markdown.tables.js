...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__66651_SHARP_){
return cljs.core.identity(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"text","text",-1790561697),p1__66651_SHARP_], null));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.string.trim,(function (){var G__66660 = clojure.string.trim((function (){var fexpr__66679 = (function (p1__66648_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(p1__66648_SHARP_),"|")){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.rest(p1__66648_SHARP_));
} else {
return p1__66648_SHARP_;
}
});
return fexpr__66679(text);
})());
var fexpr__66659 = (function (p1__66650_SHARP_){
return clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__66650_SHARP_,/\|/);
});
return fexpr__66659(G__66660);
})()));
});
