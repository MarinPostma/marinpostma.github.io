...
var len__4789__auto___68796 = arguments.length;
var i__4790__auto___68797 = (0);
while(true){
if((i__4790__auto___68797 < len__4789__auto___68796)){
args__4795__auto__.push((arguments[i__4790__auto___68797]));

var G__68798 = (i__4790__auto___68797 + (1));
i__4790__auto___68797 = G__68798;
continue;
} else {
}
break;
...
(psw.core.path_for.cljs$core$IFn$_invoke$arity$variadic = (function (route,p__68791){
var vec__68792 = p__68791;
var params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68792,(0),null);
...
/** @this {Function} */
(psw.core.path_for.cljs$lang$applyTo = (function (seq68789){
var G__68790 = cljs.core.first(seq68789);
var seq68789__$1 = cljs.core.next(seq68789);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__68790,seq68789__$1);
}));
...
var G__68795 = route;
var G__68795__$1 = (((G__68795 instanceof cljs.core.Keyword))?G__68795.fqn:null);
switch (G__68795__$1) {
case "index":
...
break;
case "projects":
return new cljs.core.Var(function(){return psw.pages.project_page.project_page;},new cljs.core.Symbol("psw.pages.project-page","project-page","psw.pages.project-page/project-page",-1688998015,null),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"ns","ns",441598760),new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"file","file",-1269645878),new cljs.core.Keyword(null,"end-column","end-column",1425389514),new cljs.core.Keyword(null,"column","column",2078222095),new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"end-line","end-line",1837326455),new cljs.core.Keyword(null,"arglists","arglists",1661989754),new cljs.core.Keyword(null,"doc","doc",1913296891),new cljs.core.Keyword(null,"test","test",577538877)],[new cljs.core.Symbol(null,"psw.pages.project-page","psw.pages.project-page",-1025381456,null),new cljs.core.Symbol(null,"project-page","project-page",172445576,null),"psw/pages/project_page.cljs",(19),(1),(21),(21),cljs.core.list(cljs.core.PersistentVector.EMPTY),null,(cljs.core.truth_(psw.pages.project_page.project_page)?psw.pages.project_page.project_page.cljs$lang$test:null)]));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__68795__$1)].join('')));
