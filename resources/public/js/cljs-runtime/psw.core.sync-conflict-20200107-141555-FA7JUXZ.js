...
psw.core.router = reitit.frontend.router.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["/",new cljs.core.Keyword(null,"index","index",-1531685915)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["/about",new cljs.core.Keyword(null,"about","about",1423892543)], null)], null));
...
var G__68260 = (i__4790__auto___68259 + (1));
i__4790__auto___68259 = G__68260;
continue;
} else {
}
break;
...
(psw.core.path_for.cljs$core$IFn$_invoke$arity$variadic = (function (route,p__68253){
var vec__68254 = p__68253;
var params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68254,(0),null);
...
/** @this {Function} */
(psw.core.path_for.cljs$lang$applyTo = (function (seq68251){
var G__68252 = cljs.core.first(seq68251);
var seq68251__$1 = cljs.core.next(seq68251);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__68252,seq68251__$1);
}));

psw.core.path_for(new cljs.core.Keyword(null,"about","about",1423892543));
psw.core.page_for = (function psw$core$page_for(route){
var G__68257 = route;
var G__68257__$1 = (((G__68257 instanceof cljs.core.Keyword))?G__68257.fqn:null);
switch (G__68257__$1) {
case "index":
...
break;
case "about":
return new cljs.core.Var(function(){return psw.pages.about_page.about_page;},new cljs.core.Symbol("psw.pages.about-page","about-page","psw.pages.about-page/about-page",-1757655492,null),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"ns","ns",441598760),new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"file","file",-1269645878),new cljs.core.Keyword(null,"end-column","end-column",1425389514),new cljs.core.Keyword(null,"column","column",2078222095),new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"end-line","end-line",1837326455),new cljs.core.Keyword(null,"arglists","arglists",1661989754),new cljs.core.Keyword(null,"doc","doc",1913296891),new cljs.core.Keyword(null,"test","test",577538877)],[new cljs.core.Symbol(null,"psw.pages.about-page","psw.pages.about-page",1664135322,null),new cljs.core.Symbol(null,"about-page","about-page",2116788009,null),"psw/pages/about_page.cljs",17,1,59,59,cljs.core.list(cljs.core.PersistentVector.EMPTY),null,(cljs.core.truth_(psw.pages.about_page.about_page)?psw.pages.about_page.about_page.cljs$lang$test:null)]));

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__68257__$1)].join('')));
...
return (function (){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div#footer","div#footer",861595109),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),"copyright \u00A9 2019 Marin Postma"], null)], null);
});
});
