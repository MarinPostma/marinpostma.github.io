...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq55882){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55883,G__55884,seq55882__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__55900_SHARP_){
return (!((cljs.core.meta(p1__55900_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55920__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e55926){var _e__54220__auto__ = e55926;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e55929){var _e__54220__auto__ = e55929;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__55936 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__55937 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__55937);

try{var map__55939 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55939__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__55936);
}});
...
var temp__5733__auto___55985 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___55985)){
var managed_print_level_55986 = temp__5733__auto___55985;
var _STAR_print_level_STAR__orig_val__55944_55987 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__55945_55988 = managed_print_level_55986;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__55945_55988);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__55942_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__55942_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__55944_55987);
}} else {
job_fn();
}
