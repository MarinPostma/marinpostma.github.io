...
var G__55604 = cljs.core.PersistentArrayMap.EMPTY;
var G__55605 = native_stack_trace;
var G__55606 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__55607 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__55604,G__55605,G__55606,G__55607) : cljs.stacktrace.parse_stacktrace.call(null,G__55604,G__55605,G__55606,G__55607));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55614__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55614__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55614__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e55613){var _e = e55613;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___55707 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___55707)){
var seen_errors_55708 = temp__5733__auto___55707;
if(cljs.core.truth_(seen_errors_55708.has(self))){
} else {
seen_errors_55708.add(self);

var temp__5735__auto___55711 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___55711)){
var sense_55714 = temp__5735__auto___55711;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_55714)].join(''));
} else {
}
}
} else {
