...
markdown.transformers.empty_line = (function markdown$transformers$empty_line(text,p__67024){
var map__67025 = p__67024;
var map__67025__$1 = (((((!((map__67025 == null))))?(((((map__67025.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__67025.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__67025):map__67025);
var state = map__67025__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67025__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67025__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
...
var G__67353 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq("<sup>"),cljs.core.second(remaining),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.seq("</sup>")], 0)));
var G__67354 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),remaining);
buf = G__67353;
remaining = G__67354;
continue;
} else {
var G__67355 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.first(remaining));
var G__67356 = cljs.core.rest(remaining);
buf = G__67355;
remaining = G__67356;
continue;
...
markdown.transformers.heading = (function markdown$transformers$heading(text,p__67054){
var map__67055 = p__67054;
var map__67055__$1 = (((((!((map__67055 == null))))?(((((map__67055.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__67055.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__67055):map__67055);
var state = map__67055__$1;
var buf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67055__$1,new cljs.core.Keyword(null,"buf","buf",-213913340));
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67055__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67055__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67055__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var heading_anchors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67055__$1,new cljs.core.Keyword(null,"heading-anchors","heading-anchors",1713527866));
...
markdown.transformers.br = (function markdown$transformers$br(text,p__67080){
var map__67084 = p__67080;
...
var state = map__67084__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67084__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67084__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
...
markdown.transformers.autourl_transformer = (function markdown$transformers$autourl_transformer(text,p__67141){
...
var state = map__67142__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67142__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var frozen_strings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67142__$1,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [clojure.string.replace(text,/<https?:\/\/[-A-Za-z0-9+&@#\/%?=~_()|!:,.;]*[-A-Za-z0-9+&@#\/%=~_()|]>/,(function (p1__67134_SHARP_){
var vec__67155 = markdown.common.freeze_string.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__67134_SHARP_,(1),(cljs.core.count(p1__67134_SHARP_) - (1))),cljs.core.deref(currently_frozen)], 0));
var url = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67155,(0),null);
var frozen_strings__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67155,(1),null);
...
return ["0",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__67167)].join('');
} else {
return G__67167;
}
});
...
var G__67174 = "&#x%02x;";
var G__67175 = (c | (0));
return (markdown.transformers._STAR_formatter_STAR_.cljs$core$IFn$_invoke$arity$2 ? markdown.transformers._STAR_formatter_STAR_.cljs$core$IFn$_invoke$arity$2(G__67174,G__67175) : markdown.transformers._STAR_formatter_STAR_.call(null,G__67174,G__67175));
}));
...
})())?text:clojure.string.replace(text,/<[\w._%+-]+@[\w.-]+\.[\w]{2,4}>/,(function (p1__67162_SHARP_){
var encoded = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.map.cljs$core$IFn$_invoke$arity$2(encoder,cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__67162_SHARP_,(1),(cljs.core.count(p1__67162_SHARP_) - (1)))));
...
markdown.transformers.set_line_state = (function markdown$transformers$set_line_state(text,p__67181){
var map__67182 = p__67181;
...
var state = map__67182__$1;
var inline_heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67182__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
...
markdown.transformers.open_paragraph = (function markdown$transformers$open_paragraph(text,p__67205){
var map__67208 = p__67205;
...
var state = map__67208__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67208__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67208__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
var blockquote = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67208__$1,new cljs.core.Keyword(null,"blockquote","blockquote",372264190));
var heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67208__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var hr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67208__$1,new cljs.core.Keyword(null,"hr","hr",1377740067));
var temp = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67208__$1,new cljs.core.Keyword(null,"temp","temp",1791541284));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67208__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var inline_heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67208__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
var last_line_empty_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67208__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67208__$1,new cljs.core.Keyword(null,"code","code",1586293142));
...
markdown.transformers.close_paragraph = (function markdown$transformers$close_paragraph(text,p__67223){
var map__67224 = p__67223;
var map__67224__$1 = (((((!((map__67224 == null))))?(((((map__67224.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__67224.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__67224):map__67224);
var state = map__67224__$1;
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67224__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67224__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
if(cljs.core.truth_((function (){var and__4174__auto__ = paragraph;
if(cljs.core.truth_(and__4174__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["`","`","`"], null),cljs.core.take_last((3),(function (){var G__67226 = next_line;
if((G__67226 == null)){
return null;
} else {
return clojure.string.trim(G__67226);
}
})()));
} else {
return and__4174__auto__;
...
markdown.transformers.code = (function markdown$transformers$code(text,p__67228){
var map__67231 = p__67228;
var map__67231__$1 = (((((!((map__67231 == null))))?(((((map__67231.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__67231.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__67231):map__67231);
var state = map__67231__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67231__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67231__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67231__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67231__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
...
markdown.transformers.codeblock = (function markdown$transformers$codeblock(text,p__67249){
var map__67250 = p__67249;
var map__67250__$1 = (((((!((map__67250 == null))))?(((((map__67250.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__67250.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__67250):map__67250);
var state = map__67250__$1;
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67250__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var codeblock_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67250__$1,new cljs.core.Keyword(null,"codeblock-end","codeblock-end",1507794736));
var indented_code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67250__$1,new cljs.core.Keyword(null,"indented-code","indented-code",-904930175));
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67250__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67250__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var trimmed = clojure.string.trim(text);
var next_line_closes_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["`","`","`"], null),cljs.core.take_last((3),(function (){var G__67255 = next_line;
if((G__67255 == null)){
return null;
} else {
return clojure.string.trim(G__67255);
}
})()));
...
var vec__67258 = cljs.core.split_with(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.not_EQ_,"\n"),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((3),trimmed));
var lang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67258,(0),null);
var code = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67258,(1),null);
 ...
 */
markdown.transformers.blockquote_1 = (function markdown$transformers$blockquote_1(text,p__67296){
var map__67298 = p__67296;
var map__67298__$1 = (((((!((map__67298 == null))))?(((((map__67298.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__67298.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__67298):map__67298);
var state = map__67298__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67298__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67298__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67298__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67298__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var trimmed = clojure.string.trim(text);
if(cljs.core.truth_((function (){var or__4185__auto__ = code;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
 ...
 */
markdown.transformers.blockquote_2 = (function markdown$transformers$blockquote_2(text,p__67305){
...
var state = map__67306__$1;
var blockquote_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67306__$1,new cljs.core.Keyword(null,"blockquote-start","blockquote-start",276074935));
var blockquote_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67306__$1,new cljs.core.Keyword(null,"blockquote-end","blockquote-end",1122544964));
var blockquote_paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67306__$1,new cljs.core.Keyword(null,"blockquote-paragraph","blockquote-paragraph",1931783682));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67306__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
...
var G__67318 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (footnotes__$1,p__67319){
var vec__67320 = p__67319;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67320,(0),null);
var label = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67320,(1),null);
...
var fexpr__67317 = (function (p1__67313_SHARP_){
return ["<ol class='footnotes'>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__67313_SHARP_),"</ol>"].join('');
});
return fexpr__67317(G__67318);
}
});
/**
...
var vec__67327 = cljs.core.re_matches(/^([0-9A-Za-z_-]*):(.*)$/,line);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67327,(0),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67327,(1),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67327,(2),null);
var vec__67330 = cljs.core.re_matches(/^    (.*)$/,line);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67330,(0),null);
var next_val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67330,(1),null);
...
var vec__67346 = ((cljs.core.sequential_QMARK_(data))?data:new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [prev_key,data], null));
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67346,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67346,(1),null);
...
var G__67513 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([acc,cljs.core.PersistentArrayMap.createAsIfByAssoc([key,new_val])], 0));
var G__67514 = cljs.core.rest(remain);
var G__67515 = key;
acc = G__67513;
remain = G__67514;
prev_key = G__67515;
