...
var G__55866 = devtools.prefs.pref(v);
v = G__55866;
continue;
} else {
return v;
...
}catch (e55822){var _e__54220__auto__ = e55822;
return false;
}})();
...
}catch (e55828){var _e__54220__auto__ = e55828;
return false;
}})();
...
}catch (e55833){var _e__54220__auto__ = e55833;
return false;
}}
}
});
...
var vec__55851 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55851,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55851,(1),null);
...
return cljs.core.some((function (p1__55857_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__55857_SHARP_);
}),template);
});
